  ...
  projects: [
    {
      ...
      techStack: ["☁️  AWS Ecosystem: EKS • ECR • VPC • IAM • Secrets Manager", "📦  Containerization: Docker • Kubernetes", "🚀  CI/CD: GitHub Actions • ArgoCD ", "🔐  Security: RBAC • ESO • OIDC • Network Policies • Trivy  • Cert-Manager", "📊  Observability: OpenTelemetry • Datadog", "🖥️  Development: Go • Nginx ", "🌐  Networking: NLB • VPC • NAT • Route 53", "📝  IaC: Terraform(Terragrunt) "],
